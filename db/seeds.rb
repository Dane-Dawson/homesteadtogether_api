...
cat9 = Category.create(name:"Hand-made")
cat9 = Category.create(name:"Other")

#productOrigins
userOrigin1 = Origin.create(name:"Chicken")
userOrigin2 = Origin.create(name:"Duck")
userOrigin3 = Origin.create(name:"Fish")
userOrigin4 = Origin.create(name:"Cow")
userOrigin5 = Origin.create(name:"Goat")
userOrigin6 = Origin.create(name:"Pig")
userOrigin7 = Origin.create(name:"Sheep")
userOrigin8 = Origin.create(name:"Alpaca")
userOrigin9 = Origin.create(name:"Animal - Other")
userOrigin10 = Origin.create(name:"Home Garden - Soil")
userOrigin11 = Origin.create(name:"Home Garden - Hydroponic")
userOrigin12 = Origin.create(name:"Home Garden - Aquaponic")
userOrigin13 = Origin.create(name:"Formal Education") #specifically for guidances
userOrigin14 = Origin.create(name:"Practical Experience") #also for guidances
userOrigin15 = Origin.create(name:"Excess Material")
...
prod2 = Product.create(name:"Tomato Seeds", origin_id: 10, category_id: 2)
prod3 = Product.create(name:"Lettuce", origin_id: 11, category_id: 2)
# prod4 = Product.create(name:"Avocado", origin_id: 10, category_id: 2)
# prod5 = Product.create(name:"Pumpkin", origin_id: 10, category_id: 2)
prod6 = Product.create(name:"Milk", origin_id: 4, category_id: 5)
prod6 = Product.create(name:"Milk", origin_id: 5, category_id: 5)
prod7 = Product.create(name:"Wool", origin_id: 7, category_id: 3)
